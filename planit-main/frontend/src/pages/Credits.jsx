...
const COMPONENTS = [
  ...
  { id:'comp-b', letter:'B', legalName:'PlanIt Backend Application',   codeName:'PlanIT',                 packageVersion:'4.2.26', licenseTitle:'PlanIt Backend Services License Agreement',        licenseVersion:'Version 5.20.26',licenseDate:'January 2026', alias:'"Backend Application" or "Software"',  anchor:'#part-four',  dot:'#86efac', rgb:'134,239,172' },
...
const SECTIONS = [
  {
    ...
    items:[
      ...
      {name:'Axios',logo:cb('axios-http.com'),url:'https://axios-http.com',note:'HTTP client'},
  ...
  },
  {
    ...
    items:[
      ...
      {name:'Mongoose',logo:gh('Automattic'),url:'https://mongoosejs.com',note:'MongoDB ODM'},
      ...
      {name:'jsonwebtoken',logo:cb('auth0.com'),url:'https://github.com/auth0/node-jsonwebtoken',note:'JWT authentication'},
      ...
      {name:'dotenv',logo:gh('motdotla'),url:'https://github.com/motdotla/dotenv',note:'Environment variables'},
      ...
      {name:'Cloudinary SDK',logo:cb('cloudinary.com'),url:'https://cloudinary.com/documentation/node_integration',note:'File storage client'},
  ...
  },
  {
    ...
    items:[
      ...
      {name:'Cloudinary',logo:cb('cloudinary.com'),url:'https://cloudinary.com',note:'File & image hosting'},
      {name:'Stripe',logo:si('stripe'),url:'https://stripe.com',note:'Payment processing'},
      {name:'Brevo',logo:cb('brevo.com'),url:'https://www.brevo.com',note:'Transactional email'},
      ...
      {name:'ntfy.sh',logo:gh('binwiederhier'),url:'https://ntfy.sh',note:'Push notifications (watchdog alerts)'},
      {name:'Discord Webhooks',logo:si('discord'),url:'https://discord.com/developers/docs/resources/webhook',note:'Alert routing'},
      {name:'Render',logo:cb('render.com'),url:'https://render.com',note:'Cloud hosting'},
